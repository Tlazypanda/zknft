...
contract PlonkVerifier {
    ...
    uint256 constant Qmx = 4639453014017586124138156371810636135213309156623773192001612391945208591861;
    uint256 constant Qmy = 7888027748461636277615196250812617412410934163856854871400768377351380063550;
    uint256 constant Qlx = 4055193804168062649395244962216631046949707959361356105687771145155858643210;
    uint256 constant Qly = 19182315654293060785604183496785129265263938848524759849636750440899362693850;
    uint256 constant Qrx = 2594229541506386277191538538735991254460112980420217926657617021850924225287;
    uint256 constant Qry = 20128480550604558879907039295427053186440532641221705440165837682166828516457;
    uint256 constant Qox = 8295832128773702046073284315533105847231017702115975989175982534196397829650;
    uint256 constant Qoy = 15555144819929082006319799142883743640991196734252789172998193111880518039330;
    uint256 constant Qcx = 17478066655722827334959102856560646647814416627935044956971584690553774179218;
    uint256 constant Qcy = 15123269809874981566216581856624102091661874109905188378265064289325772708117;
    uint256 constant S1x = 12462231304227180323779743224780967312278370206841704208592136685206230916040;
    uint256 constant S1y = 12414832311469674483213388198081637560132676856372091726784137587388080112593;
    uint256 constant S2x = 21884201291944375562945344537131486641808874759917441932398654202227888326345;
    uint256 constant S2y = 1320996960805045313998951421322245225863335962744804543089062632377023594148;
    uint256 constant S3x = 180443213341745353816713250814767096801484119069192143843328540550369236518;
    uint256 constant S3y = 16679715648803873265660717472500303047005636961936441251536922111871798734287;
    uint256 constant k1 = 2;
    uint256 constant k2 = 3;
    uint256 constant X2x1 = 15741212443553886168911196751620962653778834521138747962178287391128626323042;
    uint256 constant X2x2 = 19771226526091200687316272368730951342724519198303031450172458605622233198647;
    uint256 constant X2y1 = 12220878195183290882024495275876822991253328596753693377586980800009354182870;
    uint256 constant X2y2 = 3187518661523868835948463491651873096827510468161788485056091322205594361452;
...
contract ZKYCAgeVerification {
    PlonkVerifier plonkVerifier;
    address public EPNS_COMM_ADDRESS=0xD2ee1e96e3592d5945dDc1808834d7EE67400823;
    address public channel = address(0x4B789263E1032c4C930B47cCbe72e810006531E3);
    enum State { AWAITING_PAYMENT, AWAITING_DELIVERY, ESCROW_WAITING, COMPLETE }
    ...
    function proveAge(bytes memory proof, uint[] memory pubSignals) public {
        bool success = plonkVerifier.verifyProof(proof, pubSignals);

        if(success) {
            IEPNSCommInterface(EPNS_COMM_ADDRESS).sendNotification(channel, msg.sender, bytes(string(
            abi.encodePacked(
                "1",
                "+",
                "bafkreig6jpzi3kwue5yidnvn6vmwusucmvt5lqx5qzqejsx3xpvxvrpx4i"
            )
        )));
        }
    }
